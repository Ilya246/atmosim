...
struct bomb_data {
    ...
    int ticks;
    float round_pressure_to, round_temp_to, round_ratio_to;
    ...
    :
        ...
        tank(tank),
        round_pressure_to(round_pressure_to), round_temp_to(round_temp_to), round_ratio_to(round_ratio_to) {};
